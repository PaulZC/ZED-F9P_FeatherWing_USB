...
// This version uses the SparkFun u-blox library by Nathan Seidle to configure the RAWX messages via I2C, leaving the UART dedicated for the messages to be logged to SD card
